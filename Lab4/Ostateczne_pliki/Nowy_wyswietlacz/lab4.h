...
unsigned const int numOfDisplay[] = {0x01, 0x02, 0x04, 0x08};						// Do wyboru segmentu wyswietlacza
unsigned const int displayedNum[] = {0x7E, 0x30, 0x6D, 0x79, 0x33, 0x5B, 0x5F, 0x70, 0x7F, 0x7B};	// Do wyswietlania konkretnego numeru
